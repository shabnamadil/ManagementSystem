...
from ..base_class import BaseTelegramBot
...
def get_bot_token():
    ...
    return os.getenv('TELEGRAM_BOT_TOKEN', 'YOUR_DEFAULT_BOT_TOKEN')
    ...
    def handle_message(self, update: Update, context: CallbackContext):
        ...
        if text.startswith('/car'):
            ...
            if len(parts) == 3:
                ...
                update.message.reply_text(car_info)
            else:
                update.message.reply_text('Please use the format: /car <brand> <model>')
        else:
            update.message.reply_text('Unknown command. Use /info to get information about how to use this bot.')
